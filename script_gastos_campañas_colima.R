...
gastos_g_locales <- read.csv(file = "https://raw.githubusercontent.com/Zatara13/gasto_campanas_colima_g/main/PELO_20-21_CAMPA%C3%91A_G_RUBRO_210503.csv")

## Datos abiertos candidaturas federales
gastos_g_federales <- read.csv(file = "https://raw.githubusercontent.com/Zatara13/gasto_campanas_colima_g/main/PEFO_20-21_CAMPA%C3%91A_G_RUBRO_210503.csv")
...
f_graficado <- function(df,
  ...
  ggplot(df %>% 
    ...
    labs(title = "Gastos en las campañas 2021 en Colima",
       ...
       Nota: La fecha de corte de los datos de la gráfica es 03/05/2021.
...
ggplot(g_partidos %>% 
  ...
  labs(title = "Gastos en las campañas 2021 en Colima", ## Ponemos etiquetas a cosas
       ...
       y = "Miles de pesos",
       caption = "Fuente: Datos abiertos de fiscalización del INE.
       Nota: La fecha de corte de los datos de la gráfica es 26/04/2021.
         Créditos: Página que te avisa cuanto gastan los políticos en campaña"
  )
...
ggplot(g_partidos_sm, ## Llamamos base de datos
  ...
  geom_hline(yintercept = 60,
             ...
             color = "red")+
  labs(title = "Gastos en las campañas 2021 en Colima", ## Ponemos etiquetas a cosas
       subtitle = "Años que un trabajador con salario mínimo tardaría en reunir el dinero que los partidos gastaron en campaña hasta el 05/03/21",
       y = "Años",
       caption = "Fuente: Datos abiertos de fiscalización del INE.
       Nota 1:Se asume que el trabajador tiene un día de descanso por semana laboral.
       Nota 2: La línea roja representa el fin de la vida la vida laboral de una persona (se alcanza la edad promedio de muerte).
       Créditos: Página que te avisa cuanto gastan los políticos en campaña"
  )